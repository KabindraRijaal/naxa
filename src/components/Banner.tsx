...
function Banner() {
  return (
    <div className="relative bg-gradient-to-r from-blue-500 to-blue-700 text-white py-10 px-6 rounded-lg shadow-lg mx-auto max-w-[1120px] h-[280px] text-center overflow-hidden">
