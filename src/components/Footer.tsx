...
function Footer() {
  return (
    <footer className="bg-gray-100 py-10">
      <Banner />
      <div className="container mx-auto max-w-[1070px] px-4 flex flex-col md:flex-row justify-between">
        ...
        <div className="flex-1 md:max-w-[25%]">
          <div>
            ...
            <h3 className="text-gray-900 font-semibold mt-4">Events & Media</h3>
            <ul className="mt-2 space-y-2">
              <li>
                <a href="#" className="text-gray-700">
                  Events
