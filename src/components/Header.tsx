      ...
      <nav className=" bg-gray-50">
        <div className="lg:w-[1070px] xl:w-[1270px] max-lg:w-4/5 mx-auto flex items-center justify-between mt-2">
          ...
          <div className="flex items-center space-x-4">
            <div className="hidden md:flex justify-center items-center bg-yellow-400 w-40 h-10 text-black px-6 py-2 group relative cursor-pointer hover:bg-yellow-500">
